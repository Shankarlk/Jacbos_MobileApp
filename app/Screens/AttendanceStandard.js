...
function AttendanceStandard({ navigation,route }) {
     ...
     const fetchEventDetails = async () => {
      ...
      const renderItem = ({ item }) => (
        <TouchableOpacity
          style={styles.card}
          onPress={() => {
            navigation.navigate("ListOfStudentsScreen", { standardId: item.standardId });
          }}
        >
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.noDataText}>No Standards Because You Have Not Assinged As Class Teacher.</Text>
    )}
...
export default AttendanceStandard;
